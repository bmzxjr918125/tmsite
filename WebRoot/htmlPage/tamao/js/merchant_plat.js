...
$(document).ready(function(){
	 ...
	 * 渠道申请
	 */
	function operatorApply(){
		
		var apply_name = $("#apply_name").val();
		var apply_phone = $("#apply_phone").val();
		var apply_area = $("#apply_area").val();
		if (apply_name == "" || apply_phone == "" || apply_area == "") {
			
			alert("请输入完整信息");
			return false;
		}else {
			
			var url = "website/applyOperatorApply?apply_name="+apply_name+"&apply_phone="+apply_phone+"&apply_area="+apply_area;
			$.ajax({
		        type: 'GET',
