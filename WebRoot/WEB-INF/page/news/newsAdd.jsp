	    ...
	    <div class="centercontent">
			<div id="contentwrapper" class="contentwrapper">
				<div id="validation" class="subcontent">
					...
					<form class="stdform stdform2"  id="webSiteNewsAddForm" method="post" action="admin/newsSaveNews" enctype="multipart/form-data">
						<p>
							<label>标题<span class="inputrequiredflag">*</span></label>
	                  		<span class="field"><input type="text" name="news_title"  class="smallinput" /></span> 
						</p>
						
						<p>
		                	<label>新闻图片<span class="inputrequiredflag">*</span>
		                		<small>上传最多四张新闻图片.大小请不要超过1MB.<span style="color:#ff9900 ">图片尺寸750*420</span></small>
		                	</label>
		                    <span class="p_image">
		                    	<img class="image_add_btn" id="news_add_btn" src="images/add_image_btn.png" onclick="addFileInput(this,'news');"/>
		                    </span>
		                </p>
						...
						<p>
							...
							<span class="field">
			                	<textarea id="editor" style="height: 500px;" name="news_content" required></textarea>
			            	</span>
						</p>
