	    ...
	    <div class="centercontent">
			<div id="contentwrapper" class="contentwrapper">
				<div id="validation" class="subcontent">
					...
					<form class="stdform stdform2"  id="webSiteTrendAddForm" method="post" action="admin/noticeUpdateSaveNotice">
						<input type="hidden" value="${json.notice.id}" name="noticeId">
						<p>
							<label>标题<span class="inputrequiredflag">*</span></label>
	                  		<span class="field"><input type="text" name="notice_title"  class="smallinput" value="${json.notice.title}"/></span> 
						</p>
						<p>
							<label>内容<span class="inputrequiredflag">*</span></label>
							<span class="field">
			                	<textarea id="editor" style="height: 500px;" name="notice_content" required>${json.notice.content}</textarea>
			            	</span>
						</p>
